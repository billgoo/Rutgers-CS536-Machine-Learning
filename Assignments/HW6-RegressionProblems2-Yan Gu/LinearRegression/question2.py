...
if __name__ == "__main__":
    ...
    with open('LinearRegression/data/question2/results2.1.csv', 'w', newline='') as csvfile:
    ...
    datamap = pd.read_csv('LinearRegression/data/question2/results2.1.csv', 
                        names=['lambd','b','X1','X2','X3','X4','X5',
                            'X6','X7','X8','X9','X10',
                            'X11','X12','X13','X14','X15',
                            'X16','X17','X18','X19','X20','train_err','test_err'])
    col_l = datamap['lambd']
    ...
    # output the data to be re-format
    with open('LinearRegression/data/question2/results2.2.csv', 'w', newline='') as csvfile:
        spamwriter = csv.writer(csvfile, delimiter=',',
                                quotechar='|', quoting=csv.QUOTE_MINIMAL)
        for row in result:
            spamwriter.writerow(row)
    ...
    # re-format and draw the xy-coordinate figure
    datamap = pd.read_csv('LinearRegression/data/question2/results2.2.csv', 
                        names=['lambd','b','X1','X2','X3','X4','X5',
                            'X6','X7','X8','X9','X10',
                            'X11','X12','X13','X14','X15',
                            'X16','X17','X18','X19','X20','train_err','test_err'])
